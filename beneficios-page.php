...
//
$queryTxt = "SELECT * FROM textos WHERE txt_id = 8";
...
<head>
    ...
    <!-- Meta tags -->
    <meta content="BENEFICIOS | SOCIOS | APOSGRAN | Asociación Argentina de Poscosecha de Granos" name="title" />
    ...
    <!--Metatags FB-->
    <meta property="og:title" content="BENEFICIOS | SOCIOS | APOSGRAN | Asociación Argentina de Poscosecha de Granos">
    ...
    <meta name="twitter:title" content="BENEFICIOS | SOCIOS | APOSGRAN | Asociación Argentina de Poscosecha de Granos">
    ...
    <!-- Custom styles for this template -->
    <link href="<?php echo _CONST_DOMINIO_ ?>assets/css/custom.css?v=18" rel="stylesheet">
        ...
        <section class="contenido-curso">
            <div class="container">
                <div class="row">
                    ...
                    <!--<div class="col-lg-4 offset-lg-0 col-xl-3 offset-xl-1 benefcios-txt">
                        <div class="row">

                            <div class="col-md-12 mb-2">
                                <h2>Cuotas semestrales en concepto de socios</h2>
                            </div>

                            <div class="col-md-12 mb-4">
                                <ol>
                                    <li>Grandes empresas: <strong>$11700</strong></li>
                                    <li>Medianas y pequeñas empresas / acopios / cooperativas:<strong> $9700</strong></li>
                                    <li>Personas físicas: <strong>$3400</strong></li>
                                </ol>
                            </div>
