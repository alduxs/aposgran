<?php
	...
	if ($host == "localhost" || $host == "192.168.100.16"){
		$urlweb = "http://".$host."/cajanew"; // Pagina Principal
		$urladmin = "http://".$host."/cajanew/admin"; // Admin Pagina Principal
		$urlwebelpunto = "http://".$host."/cajanew/elpunto/"; // Pagina Principal El Punto
		$urladminelpunto = "http://".$host."/cajanew/elpunto/admin/"; // Admin Pagina Principal El Punto
		$urlwebliberi = "http://".$host."/cajanew/liberi/"; // Pagina Principal Liberi
		$urladminliberi = "http://".$host."/cajanew/liberi/admin/"; // Admin Pagina Principal Liberi
	} else {
		$urlweb = "https://".$host; // Pagina Principal
		$urladmin = "https://".$host."/admin"; // Admin Pagina Principal
		$urlwebelpunto = "https://".$host."/elpunto/"; // Pagina Principal El Punto
		$urladminelpunto = "https://".$host."/elpunto/admin/"; // Admin Pagina Principal El Punto
		$urlwebliberi = "https://".$host."/liberi/"; // Pagina Principal Liberi
		$urladminliberi = "https://".$host."/liberi/admin/"; // Admin Pagina Principal Liberi
	};

	define ('_CONST_DOMINIO_', $urlweb);
	define ('_CONST_BACKEND_', $urladmin);

	define ('_CONST_DOMINIO_EP_', $urlwebelpunto);
	define ('_CONST_BACKEND_EP_', $urladminelpunto);

	define ('_CONST_DOMINIO_LB_', $urlwebliberi);
	define ('_CONST_BACKEND_LB_', $urladminliberi);

	define ('_CONST_TITLE_', "Caja Ingenieros");
	define ('_CONST_TITLE_EP_', "El Punto");
	define ('_CONST_TITLE_LB_', "Liberi");
