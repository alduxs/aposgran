...
<head>
    ...
    <!-- Meta tags -->
    <meta content="COSECHA FINA | SEMINARIOS | APOSGRAN | Asociación Argentina de Poscosecha de Granos" name="title" />
    ...
    <!--Metatags FB-->
    <meta property="og:title" content="COSECHA FINA | SEMINARIOS | APOSGRAN | Asociación Argentina de Poscosecha de Granos">
    ...
    <meta name="twitter:title" content="COSECHA FINA | SEMINARIOS | APOSGRAN | Asociación Argentina de Poscosecha de Granos">
    ...
    <title>COSECHA FINA | SEMINARIOS | APOSGRAN | Asociación Argentina de Poscosecha de Granos</title>
...
<body id="top">
    ...
    <header class="header-i">
        ...
        <!-- Slider -->
        <div class="slider-i slide-seminariocf" style="margin-top: 0px;">
            <h2>Seminario Cosecha Fina</h2>
            <p>TRIGO Pan - CEBADA Cervecera</p>
            <img src="<?php echo _CONST_DOMINIO_ ?>assets/img/trigo-cebada.png" alt="" class="img-fluid">
        </div>
