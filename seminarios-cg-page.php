...
//
$queryTxt = "SELECT * FROM textos WHERE txt_id = 7";
...
<head>
    ...
    <!-- Meta tags -->
    <meta content="COSECHA GRUESA | SEMINARIOS | APOSGRAN | Asociación Argentina de Poscosecha de Granos" name="title" />
    ...
    <!--Metatags FB-->
    <meta property="og:title" content="COSECHA GRUESA | SEMINARIOS | APOSGRAN | Asociación Argentina de Poscosecha de Granos">
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?php echo _CONST_DOMINIO_ ?>seminarios/cosecha-gruesa">
    ...
    <meta name="twitter:title" content="COSECHA GRUESA | SEMINARIOS | APOSGRAN | Asociación Argentina de Poscosecha de Granos">
    ...
    <title>COSECHA GRUESA | SEMINARIOS | APOSGRAN | Asociación Argentina de Poscosecha de Granos</title>
...
<body id="top">
    ...
    <header class="header-i">
        ...
        <!-- Slider -->
        <div class="slider-i slide-seminariocg" style="margin-top: 0px;">
            <h2>Seminario Cosecha Gruesa</h2>
            <p>SOJA - MAÍZ</p>
            <img src="<?php echo _CONST_DOMINIO_ ?>assets/img/soja-maiz.png" alt="" class="img-fluid">
        </div>
