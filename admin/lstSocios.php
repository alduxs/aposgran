...
$query = "SELECT * FROM socios ORDER BY soc_nombre ASC, soc_id ASC LIMIT ?,?";
			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-sm-12">
					...
					<ol class="breadcrumb">
						...
						<li class="active"><strong>Listar socios</strong></li>
					</ol>
				</div>
			</div>
			<div class="wrapper wrapper-content animated fadeInRight">
					...
					<div class="col-lg-12">
						<div class="ibox float-e-margins">
							<div class="ibox-content">
								<form name="frm" method="post" action="svSocios.php">
										...
										<tbody>
											...
											<?php while ($arrContenido = $rsCont->fetch(PDO::FETCH_BOTH)) { ?>
												<tr>
													...
													<td><?php echo $arrContenido["soc_nombre"]; ?></td>
													<td> <a href="<?php echo _CONST_DOMINIO_."assets/socios/" ?><?php echo $arrContenido["soc_imagen"]; ?>" target="_blank"> <?php echo _CONST_DOMINIO_."assets/socios/" ?><?php echo $arrContenido["soc_imagen"]; ?></a></td>
													<td class="tooltip-demo">
														<a href="javascript:;" onclick="delRegistro('<?php echo $arrContenido["soc_id"]?>','<?php echo $arrContenido["soc_imagen"]?>','socios',<?php echo $intPage ?>);" class="btn btn-primary btn-bitbucket" data-toggle="tooltip" data-placement="bottom" title="Borrar"><i class="fa fa-trash-o"></i></a>
													</td>
												</tr>
												<?php $intCounter++; ?>
											<?php } ?>
				...
				<div class="row">
					<div class="col-lg-12 paginador">
						<?php echo printPaginado("lstSocios.php", $intQtyPages, $intPage, "socios");?>
					</div>
				</div>
			</div>
			<div class="footer">
