...
$query = "SELECT * FROM scf2023 WHERE scf2023_id=" . $intIdCont;
      ...
      <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-sm-12">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><strong>Modificar inscripción</strong></li>
          </ol>
        </div>
      </div>
          ...
          <div class="col-lg-12">
            <div class="ibox float-e-margins">
              <div class="ibox-content">
                <form action="svScfin.php" method="post" enctype="multipart/form-data" name="form1">
                  ...
                  <div class="form-group col-xs-12">
                    ...
                    <input type="text" name="nombre" id="nombre" class="form-control" value="<?php echo $arrCont["scf2023_nombre"] ?>">
                  </div>
                  ...
                  <div class="form-group col-xs-12">
                    ...
                    <input type="text" name="email" id="email" class="form-control" value="<?php echo $arrCont["scf2023_email"] ?>">
                  </div>
                  <div class="hr-line-dashed col-xs-12"></div>
                  ...
                  <div class="form-group col-xs-12">
                    ...
                    <input type="text" name="telefono" id="telefono" class="form-control" value="<?php echo $arrCont["scf2023_tel"] ?>">
                  </div>
                  <div class="hr-line-dashed col-xs-12"></div>
                 ...
                 <div class="form-group col-xs-12">
                    ...
                    <input type="text" name="ciudad" id="ciudad" class="form-control" value="<?php echo $arrCont["scf2023_ciudad"] ?>">
                  </div>
                  <div class="hr-line-dashed col-xs-12"></div>

                  <!-- Participa -->
                  <div class="form-group col-xs-12">
                    <label for="participa">Participa en forma</label>
                    <p><label class="checkbox-inline i-checks"> <input type="radio" value="1" name="participa" <?php if (!(strcmp($arrCont["scf2023_tipo"], 1))) { echo "checked=\"checked\""; } ?>> <i></i> Particular </label><label class="checkbox-inline i-checks"> <input name="participa" type="radio" value="2" <?php if (!(strcmp($arrCont["scf2023_tipo"], 2))) { echo "checked=\"checked\""; } ?>> <i></i> Empresa </label></p>
                    </div>
                  <div class="hr-line-dashed col-xs-12"></div>
                 ...
                 <div class="form-group col-xs-12">
                    ...
                    <input type="text" name="dni" id="dni" class="form-control" value="<?php echo $arrCont["scf2023_dni"] ?>">
                  </div>
                  <div class="hr-line-dashed col-xs-12"></div>
                 ...
                 <div class="form-group col-xs-12">
                    ...
                    <input type="text" name="cuit" id="cuit" class="form-control" value="<?php echo $arrCont["scf2023_cuit"] ?>">
                  </div>
                  <div class="hr-line-dashed col-xs-12"></div>
                 ...
                 <div class="form-group col-xs-12">
                    ...
                    <input type="text" name="organizacion" id="organizacion" class="form-control" value="<?php echo $arrCont["scf2023_organizacion"] ?>">
                  </div>
                  <div class="hr-line-dashed col-xs-12"></div>
