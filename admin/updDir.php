...
//
$objCont = new General();
$query = "SELECT * FROM comision WHERE com_id=" . $intIdCont;
      ...
      <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-sm-12">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><strong>Modificar docente</strong></li>
          </ol>
        </div>
      </div>
          ...
          <div class="col-lg-12">
            <div class="ibox float-e-margins">
              <div class="ibox-content">
                <form action="svDir.php" method="post" enctype="multipart/form-data" name="form1">
                  ...
                  <div class="form-group col-xs-12">
                    ...
                    <input type="text" name="nombre" id="nombre" class="form-control" value="<?php echo $arrCont["com_nombre"] ?>">
                  </div>
                  <div class="hr-line-dashed col-xs-12"></div>
                   ...
                   <div class="form-group col-xs-12">
                    ...
                    <input type="text" name="cargo" id="cargo" class="form-control" value="<?php echo $arrCont["com_cargo"] ?>">
                  </div>
                  <div class="hr-line-dashed col-xs-12"></div>
                 ...
                 <div class="form-group col-xs-12">
                    ...
                    <input type="text" name="empresa" id="empresa" class="form-control" value="<?php echo $arrCont["com_pertenencia"] ?>">
                  </div>
                  <div class="hr-line-dashed col-xs-12"></div>
                  ...
                  <div class="form-group col-xs-12">
                    ...
                    <?php if ($arrCont["com_imagen"]!="nd") { ?>
                      <div class="imagem-p">
                        <img src="../assets/directivos/<?php echo $arrCont["com_imagen"] ?>"  width="200" height="100%">
                      </div>
                      <label for="imagen">Nueva Imagen</label>
                      <input type="file" name="archivo" id="archivo" class="form-control form-file">
                      <input name="imagactual" type="hidden" value="<?php echo $arrCont["com_imagen"] ?>">
                    <?php } else {?>
                      <input type="file" name="archivo" id="archivo" class="form-control form-file">
                    <?php } ?>
                  </div>
                  ...
                  <div class="form-group col-xs-12">
                    ...
                    <input type="text" name="posicion" id="posicion" class="form-control" value="<?php echo $arrCont["com_posicion"] ?>">
                  </div>
                  <div class="hr-line-dashed col-xs-12"></div>
