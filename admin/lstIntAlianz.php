...
$query = "SELECT * FROM integrantesalianzas";
...
$query = "SELECT * FROM integrantesalianzas ORDER BY int_nombre ASC, int_id ASC LIMIT ?,?";
	...
	<div id="wrapper">
		...
		<div id="page-wrapper" class="gray-bg">
			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-sm-12">
					<h2>Listar Integrantes de Alianzas</h2>
					<ol class="breadcrumb">
						<li><a href="home.php?seccion=inicio">Home</a></li>
						<li><a href="#">Integrantes de Alianzas</a></li>
						<li class="active"><strong>Listar integrantes de alianzas</strong></li>
					</ol>
				</div>
			</div>
			<div class="wrapper wrapper-content animated fadeInRight">
					...
					<div class="col-lg-12">
						<div class="ibox float-e-margins">
							<div class="ibox-content">
								<form name="frm" method="post" action="svIntAlianz.php">
									...
									<table class="table table-striped">
										...
										<tbody>
											...
											<?php while ($arrContenido = $rsCont->fetch(PDO::FETCH_BOTH)) { ?>
												<tr>
													<td><?php echo $arrContenido["int_nombre"]; ?></td>

                                                    <td> <img src="../assets/alianzas/<?php echo $arrContenido["int_logo"]; ?>" alt="" width="150px" height="auto">  </td>
													
													<td class="tooltip-demo">
														<a href="updIntAlianz.php?seccion=intalianzas&id=<?php echo $arrContenido["int_id"]; ?>&intPage=<?php echo $intPage ?>" class="btn btn-primary btn-bitbucket" data-toggle="tooltip" data-placement="bottom" title="Editar"><i class="fa fa-pencil"></i></a>
														<a href="javascript:;" onclick="delRegistro('<?php echo $arrContenido["int_id"]?>','','intalianzas',<?php echo $intPage ?>);" class="btn btn-primary btn-bitbucket" data-toggle="tooltip" data-placement="bottom" title="Borrar"><i class="fa fa-trash-o"></i></a>
													</td>
												</tr>
												<?php $intCounter++; ?>
											<?php } ?>
				...
				<div class="row">
					<div class="col-lg-12 paginador">
						<?php echo printPaginado("lstIntAlianz.php", $intQtyPages, $intPage, "intalianzas");?>
					</div>
				</div>
			</div>
			<div class="footer">
