...
$query = "SELECT * FROM docentes ORDER BY doc_nombre ASC, doc_id ASC LIMIT ?,?";
			...
			<div class="wrapper wrapper-content animated fadeInRight">
					...
					<div class="col-lg-12">
						<div class="ibox float-e-margins">
							<div class="ibox-content">
								<form name="frm" method="post" action="svDoc.php">
										...
										<tbody>
											...
											<?php while ($arrContenido = $rsCont->fetch(PDO::FETCH_BOTH)) { ?>
												<tr>
													...
													<td><?php echo $arrContenido["doc_nombre"]; ?></td>
													
													<td class="tooltip-demo">
														<a href="updDoc.php?seccion=docentes&id=<?php echo $arrContenido["doc_id"]; ?>&intPage=<?php echo $intPage ?>" class="btn btn-primary btn-bitbucket" data-toggle="tooltip" data-placement="bottom" title="Editar"><i class="fa fa-pencil"></i></a>
														<a href="javascript:;" onclick="delRegistro('<?php echo $arrContenido["doc_id"]?>','','docentes',<?php echo $intPage ?>);" class="btn btn-primary btn-bitbucket" data-toggle="tooltip" data-placement="bottom" title="Borrar"><i class="fa fa-trash-o"></i></a>
													</td>
												</tr>
												<?php $intCounter++; ?>
											<?php } ?>
				...
				<div class="row">
					<div class="col-lg-12 paginador">
						<?php echo printPaginado("lstDoc.php", $intQtyPages, $intPage, "docentes");?>
					</div>
				</div>
			</div>
			<div class="footer">
