...
//
$objCont = new General();
$query = "SELECT * FROM integrantesalianzas WHERE int_id=" . $intIdCont;
  ...
  <div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg">
      ...
      <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-sm-12">
          <h2>Modificar Integrante de Alianza</h2>
          <ol class="breadcrumb">
            <li><a href="home.php?seccion=inicio">Home</a></li>
            <li><a href="#">Alianzas</a></li>
            <li class="active"><strong>Modificar integrante de alianza</strong></li>
          </ol>
        </div>
      </div>
          ...
          <div class="col-lg-12">
            <div class="ibox float-e-margins">
              <div class="ibox-content">
                <form action="svIntAlianz.php" method="post" enctype="multipart/form-data" name="form1">
                  ...
                  <div class="form-group col-xs-12">
                    ...
                    <input type="text" name="nombre" id="nombre" class="form-control" value="<?php echo $arrCont["int_nombre"] ?>">
                  </div>
                  ...
                  <div class="form-group col-xs-12">
                    ...
                    <?php if ($arrCont["int_logo"]!="nd") { ?>
                      <div class="imagem-p">
                        <img src="../assets/alianzas/<?php echo $arrCont["int_logo"] ?>"  width="200" height="100%">
                      </div>
