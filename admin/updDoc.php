...
//
$objCont = new General();
$query = "SELECT * FROM docentes WHERE doc_id=" . $intIdCont;
          ...
          <div class="col-lg-12">
            <div class="ibox float-e-margins">
              <div class="ibox-content">
                <form action="svDoc.php" method="post" enctype="multipart/form-data" name="form1">
                  ...
                  <div class="form-group col-xs-12">
                    ...
                    <input type="text" name="nombre" id="nombre" class="form-control" value="<?php echo $arrCont["doc_nombre"] ?>">
                  </div>
                  ...
                  <div class="form-group col-xs-12">
                    ...
                    <textarea name="texto" rows="12" id="texto"><?php echo $arrCont["doc_text"] ?></textarea>
                  </div>
                  ...
                  <div class="form-group col-xs-12">
                    ...
                    <?php if ($arrCont["doc_imagen"]!="nd") { ?>
                      <div class="imagem-p">
                        <img src="../assets/docentes/<?php echo $arrCont["doc_imagen"] ?>"  width="200" height="100%">
                      </div>
                      <label for="imagen">Nueva Imagen</label>
                      <input type="file" name="archivo" id="archivo" class="form-control form-file">
                      <input name="imagactual" type="hidden" value="<?php echo $arrCont["doc_imagen"] ?>">
                    <?php } else {?>
                      <input type="file" name="archivo" id="archivo" class="form-control form-file">
                    <?php } ?>
                  </div>
