  ...
  <div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg">
      ...
      <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-sm-12">
          <h2>Agregar Integrante de Alianza</h2>
          <ol class="breadcrumb">
            <li><a href="home.php?seccion=inicio">Home</a></li>
            <li><a href="#">Alianzas</a></li>
            <li class="active"><strong>Agregar integrante de alianza</strong></li>
          </ol>
        </div>
      </div>
          ...
          <div class="col-lg-12">
            <div class="ibox float-e-margins">
              <div class="ibox-content">
                <form method="post" action="svIntAlianz.php" enctype="multipart/form-data" name="form1">
