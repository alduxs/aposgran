...
$query = "SELECT * FROM alianzas ORDER BY al_nombre ASC, al_id ASC LIMIT ?,?";
			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-sm-12">
					...
					<ol class="breadcrumb">
						...
						<li class="active"><strong>Listar docentes</strong></li>
					</ol>
				</div>
			</div>
			<div class="wrapper wrapper-content animated fadeInRight">
					...
					<div class="col-lg-12">
						<div class="ibox float-e-margins">
							<div class="ibox-content">
								<form name="frm" method="post" action="svInfAlian.php">
										...
										<tbody>
											...
											<?php while ($arrContenido = $rsCont->fetch(PDO::FETCH_BOTH)) { ?>
												<tr>
													...
													<td><?php echo $arrContenido["al_nombre"]; ?></td>
                                                    <td><?php if ($arrContenido["al_publicado"]==0) { ?><a href="#" class="btn btn-default btn-circle"><i class="fa fa-check"></i></a><?php } else { ?><a href="#" class="btn btn-info btn-circle"><i class="fa fa-check"></i></a><?php } ?></td>
													
													<td class="tooltip-demo">
														<a href="updInfAlian.php?seccion=alianzas&id=<?php echo $arrContenido["al_id"]; ?>&intPage=<?php echo $intPage ?>" class="btn btn-primary btn-bitbucket" data-toggle="tooltip" data-placement="bottom" title="Editar"><i class="fa fa-pencil"></i></a>
														<a href="javascript:;" onclick="delRegistro('<?php echo $arrContenido["al_id"]?>','','alianzas',<?php echo $intPage ?>);" class="btn btn-primary btn-bitbucket" data-toggle="tooltip" data-placement="bottom" title="Borrar"><i class="fa fa-trash-o"></i></a>
													</td>
												</tr>
												<?php $intCounter++; ?>
											<?php } ?>
				...
				<div class="row">
					<div class="col-lg-12 paginador">
						<?php echo printPaginado("lstInfAlian.php", $intQtyPages, $intPage, "alianzas");?>
					</div>
				</div>
			</div>
			<div class="footer">
