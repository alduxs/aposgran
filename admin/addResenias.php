      ...
      <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-sm-12">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><strong>Agregar Reseña</strong></li>
          </ol>
        </div>
      </div>
          ...
          <div class="col-lg-12">
            <div class="ibox float-e-margins">
              <div class="ibox-content">
                <form method="post" action="svResenias.php" name="form1">
                  ...
                  <div class="form-group col-xs-12">
                    ...
                    <select name="curso" id="curso" class="form-control" required>
                      ...
                      <?php while ($arrCurso = $rsCursos->fetch(PDO::FETCH_BOTH)) { ?>
                        <option value="<?php echo $arrCurso["id"]; ?>"><?php echo $arrCurso["titulo"]; ?></option>
                      <?php } ?>
                    </select>
                  </div>
                  <div class="hr-line-dashed col-xs-12"></div>
                  ...
                  <div class="form-group col-xs-12">
                    ...
                    <p>
                      <label class="checkbox-inline i-checks"><input type="radio" value="1" name="home"> <i></i> Si </label>
                      <label class="checkbox-inline i-checks"><input name="home" type="radio" value="0" checked> <i></i> No </label>
                    </p>
                  </div>
                  <div class="hr-line-dashed col-xs-12"></div>
