...
$query = "SELECT * FROM comision ORDER BY com_posicion ASC, com_nombre ASC LIMIT ?,?";
			...
			<div class="wrapper wrapper-content animated fadeInRight">
					...
					<div class="col-lg-12">
						<div class="ibox float-e-margins">
							<div class="ibox-content">
								<form name="frm" method="post" action="svDir.php">
										...
										<tbody>
											...
											<?php while ($arrContenido = $rsCont->fetch(PDO::FETCH_BOTH)) { ?>
												<tr>
													...
													<td><?php echo $arrContenido["com_nombre"]; ?></td>
                                                    <td><?php echo $arrContenido["com_cargo"]; ?></td>
                                                    <td><?php echo $arrContenido["com_posicion"]; ?></td>
													
													<td class="tooltip-demo">
														<a href="updDir.php?seccion=cdirectiva&id=<?php echo $arrContenido["com_id"]; ?>&intPage=<?php echo $intPage ?>" class="btn btn-primary btn-bitbucket" data-toggle="tooltip" data-placement="bottom" title="Editar"><i class="fa fa-pencil"></i></a>
														<a href="javascript:;" onclick="delRegistro('<?php echo $arrContenido["com_id"]?>','','cdirectiva',<?php echo $intPage ?>);" class="btn btn-primary btn-bitbucket" data-toggle="tooltip" data-placement="bottom" title="Borrar"><i class="fa fa-trash-o"></i></a>
													</td>
												</tr>
												<?php $intCounter++; ?>
											<?php } ?>
				...
				<div class="row">
					<div class="col-lg-12 paginador">
						<?php echo printPaginado("lstDir.php", $intQtyPages, $intPage, "cdirectiva");?>
					</div>
				</div>
			</div>
			<div class="footer">
