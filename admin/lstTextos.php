...
$query = "SELECT * FROM textos ORDER BY txt_id ASC";
			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-sm-12">
					...
					<ol class="breadcrumb">
						...
						<li class="active"><strong>Listar textos</strong></li>
					</ol>
				</div>
			</div>
			<div class="wrapper wrapper-content animated fadeInRight">
									...
									<table class="table table-striped">
										...
										<tbody>
											...
											<?php while ($arrContenido = $rsCont->fetch(PDO::FETCH_BOTH)) { ?>
												<?php //var_dump($arrContenido); ?>
												<tr>
													

													<td><?php echo $arrContenido["txt_nombre"]; ?></td>

													<td class="tooltip-demo">
														<a href="updTextos.php?seccion=textos&id=<?php echo $arrContenido["txt_id"]; ?>" class="btn btn-primary btn-bitbucket" data-toggle="tooltip" data-placement="bottom" title="Editar"><i class="fa fa-pencil"></i></a>
				...
				<div class="row">
					<div class="col-lg-12 paginador">
						<?php //echo printPaginado("lstNovedades.php", $intQtyPages, $intPage, "novedades");?>
					</div>
				</div>
			</div>
			<div class="footer">
