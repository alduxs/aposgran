    ...
    <div id="page-wrapper" class="gray-bg">
      ...
      <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-sm-12">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><strong>Agregar archivo</strong></li>
          </ol>
        </div>
      </div>
      <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row">
          ...
          <div class="col-lg-12">
            <div class="alert alert-danger">Formato de archivo no permitido. </div>
          </div>
          <?php } ?>
          ...
          <div class="col-lg-12">
            <div class="ibox float-e-margins">
              <div class="ibox-content">
                <form method="post" action="svArchivos.php" enctype="multipart/form-data" name="form1">
                  ...
                  <div class="form-group col-xs-12">
                    <!-- Imagen -->
                    <label for="archivo">Archivo (.jpg / .png / .gif / .pdf / .docx / .doc)</label>
