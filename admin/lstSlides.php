...
$query = "SELECT * FROM slides ORDER BY id_publicado DESC,id_posicion ASC,id_slide DESC LIMIT ?,?";
			...
			<div class="wrapper wrapper-content animated fadeInRight">
										...
										<tbody>
											...
											<?php while ($arrContenido = $rsCont->fetch(PDO::FETCH_BOTH)) { ?>
												<tr>
													...
													<td><?php echo $arrContenido["ds_titulo"]; ?></td>
                                                    <?php if($arrContenido["ds_imagen"] != "nd"){?>
													    <td> <img src="../assets/slides/<?php echo $arrContenido["ds_imagen"]; ?>" alt="" width="500px" height="auto">  </td>
                                                    <?php } else { ?>
                                                        <td>-</td>
                                                    <?php } ?>
													<td><?php if ($arrContenido["id_publicado"]==0) { ?><a href="#" class="btn btn-default btn-circle"><i class="fa fa-check"></i></a><?php } else { ?><a href="#" class="btn btn-info btn-circle"><i class="fa fa-check"></i></a><?php } ?></td>
													<td><?php echo $arrContenido["id_posicion"]; ?></td>
													<td class="tooltip-demo">
														<a href="updSlides.php?seccion=slides&id=<?php echo $arrContenido["id_slide"]; ?>&intPage=<?php echo $intPage ?>" class="btn btn-primary btn-bitbucket" data-toggle="tooltip" data-placement="bottom" title="Editar"><i class="fa fa-pencil"></i></a>
														<a href="javascript:;" onclick="delRegistro('<?php echo $arrContenido["id_slide"]?>','','slides',<?php echo $intPage ?>);" class="btn btn-primary btn-bitbucket" data-toggle="tooltip" data-placement="bottom" title="Borrar"><i class="fa fa-trash-o"></i></a>
													</td>
												</tr>
												<?php $intCounter++; ?>
											<?php } ?>
				...
				<div class="row">
					<div class="col-lg-12 paginador">
						<?php echo printPaginado("lstSlides.php", $intQtyPages, $intPage, "slides");?>
					</div>
				</div>
			</div>
			<div class="footer">
