...
//
$objCont = new General();
$query = "SELECT * FROM slides WHERE id_slide=" . $intIdCont;
              ...
              <div class="ibox-content">
                <form action="svSlides.php" method="post" enctype="multipart/form-data" name="form1">
                  ...
                  <div class="form-group col-xs-12">
                    ...
                    <input type="text" name="titulo" id="titulo" class="form-control" value="<?php echo $arrCont["ds_titulo"] ?>">
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-8">
                    <h4>Imagen Principal (Relación 4:1 - Tamaño mínimo: 1980 px de ancho por 495 px de alto)</h4>
                      <div class="image_area3">
                          <label for="upload_image2">
                            <?php if($arrCont["ds_imagen"] != "nd"){ ?>
                              <img src="../assets/slides/<?php echo $arrCont["ds_imagen"]; ?>" id="uploaded_image2" class="img-responsive" />
                            <?php } else { ?>
                            ...
                            <?php if($arrCont["ds_titulo"] != "nd"){ ?>
                              <input type="hidden" name="imageOldRect" id="imageOldRect" value="<?php echo $arrCont["ds_imagen"]; ?>">
                            <?php } else { ?>
