  ...
  <div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg">
      ...
      <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-sm-12">
          <h2>Agregar Alianza</h2>
          <ol class="breadcrumb">
            <li><a href="home.php?seccion=inicio">Home</a></li>
            <li><a href="#">Alianzas</a></li>
            <li class="active"><strong>Agregar alianza</strong></li>
          </ol>
        </div>
      </div>
          ...
          <div class="col-lg-12">
            <div class="ibox float-e-margins">
              <div class="ibox-content">
                <form method="post" action="svInfAlian.php" enctype="multipart/form-data" name="form1">
                  ...
                  <div class="form-group col-xs-12">
                    ...
                    <select name="integrantes[]" class="select2_demo_4 form-control" id="integrantes" multiple="">
                      ...
                      <?php while ($arrPost = $rsPost->fetch(PDO::FETCH_BOTH)) { ?>
                        <option value="<?php echo $arrPost["int_id"] ?>"><?php echo $arrPost["int_nombre"] ?></option>
                      <?php } ?>
                    </select>
                  </div>
                  <div class="hr-line-dashed col-xs-12"></div>
